...
public class frmDangNhap extends JFrame {
    ...
    private String backgroundPath = "hinhanh\\BGStore.PNG"; // Đường dẫn mặc định
    ...
    private boolean kiemTraDangNhap(String maNV, String matKhau) {
        try (Connection conn = ConnectDB.getConnection("DANGNHAP")) { // Kết nối đến database DANGNHAP
            String sql = "SELECT * FROM ACCOUNT WHERE MANV = ? AND PASS = ?";
    ...
    private void btnDangNhapActionPerformed() {
        ...
        if (kiemTraDangNhap(maNV, matKhau)) {
            ...
            JOptionPane.showMessageDialog(this, "Vui lòng nhập lại!", "Thông báo", JOptionPane.ERROR_MESSAGE);
        }
    }
