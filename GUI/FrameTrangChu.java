...
//            public void run() {
//                try {
//                    FrameTrangChu frame = new FrameTrangChu("NV1", "Quản lý");
...
//    }
    ...
    public FrameTrangChu(String maNV, String chucVu) {
        ...
        BackgroundPanel pnlBackGround = new BackgroundPanel("image\\market.jpg");
        ...
        btnTrangChu.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                pnlBackGround.add(new BackgroundPanel("image\\market.jpg"), BorderLayout.CENTER);
                revalidate();
                repaint();
            }
        });
        ...
        btnKhachHang.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                pnlBackGround.removeAll();
                pnlBackGround.add(frameQLKH, BorderLayout.CENTER);
                revalidate();
                repaint();
            }
        });
        ...
        btnNhanVien.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                pnlBackGround.removeAll();
                pnlBackGround.add(frameQLNV, BorderLayout.CENTER);
                revalidate();
                repaint();
            }
        });
        ...
        btnSanPham.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                pnlBackGround.removeAll();
                pnlBackGround.add(frameQLSP, BorderLayout.CENTER);
                revalidate();
                repaint();
            }
        });
        ...
        btnHoaDon.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                pnlBackGround.removeAll();
                pnlBackGround.add(frameQLHD, BorderLayout.CENTER);
                revalidate();
                repaint();
            }
        });
