...
public class FrameQuanLyKhachHang extends JPanel {
	...
	public FrameQuanLyKhachHang() {
		...
		btnNewButton.setIcon(new ImageIcon("icon\\btnThem.png"));
		...
		btnLu.setIcon(new ImageIcon("icon\\btnLuu.png"));
		...
		btnSa.setForeground(new Color(0, 128, 255));
		...
		btnThot.setIcon(new ImageIcon("icon\\btnprint.png"));
		...
		lblNewLabel.setIcon(new ImageIcon("logoMTP 1.png"));
		...
		table.setModel(new DefaultTableModel(
				...
				new String[] { "M\u00E3 kh\u00E1ch h\u00E0ng", "T\u00EAn kh\u00E1ch h\u00E0ng",
						"S\u1ED1 \u0111i\u1EC7n tho\u1EA1i", "Email", "Ng\u00E0y sinh", "\u0110\u1ECBa ch\u1EC9" }) {
